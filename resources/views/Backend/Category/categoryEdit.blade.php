        ...
        <div class="card-body">
          ...
          <form class="forms-sample" action="{{route('category.update',$categoryEdit->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control text-white" name="name" id="exampleInputUsername1" value="{{$categoryEdit->name}}" required>
              @error('name')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control text-white" name="slug"  id="exampleInputUsername1" value="{{$categoryEdit->slug}}" required>
                @error('slug')
                <p class=" text-danger" role="alert">
                    {{ $message }}
                </p>
