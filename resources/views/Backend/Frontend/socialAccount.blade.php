    ...
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms-sample" action="{{route('scocial.account.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
              <label for="name">Social Accouont Name</label>
              <input type="text" class="form-control text-white" name="name" id="name" value="{{old('name')}}" placeholder="Enter your Social Accouont  Name">
              @error('name')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control text-white" name="link" value="{{old('link')}}" id="link" placeholder="Enter your Social Accouont Link">
                @error('link')
                <p class=" text-danger" role="alert">
                    {{ $message }}
                </p>
