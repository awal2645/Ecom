        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('scocial.account.update', $socialAccountEdit->id) }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="name">Social Accouont Name</label>
                            <input type="text" class="form-control text-white" name="name" id="name"
                                value="{{ $socialAccountEdit->name }}" placeholder="Enter your Social Accouont  Name">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control text-white" name="link"
                                value="{{ $socialAccountEdit->link }}" id="link"
                                placeholder="Enter your Social Accouont Link">
                            @error('link')
                                <p class=" text-danger" role="alert">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="icon_name" class="form-control text-white"
                                value="{{ $socialAccountEdit->icon_name }}" id="icon_name"
                                placeholder="Enter Social Accouont Icon">
                            @error('icon_name')
                                <p class=" text-danger" role="alert">
                                    {{ $message }}
                                </p>
