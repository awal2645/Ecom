...
<div class="container">
    <div class="row">
        <div class="col-4"> <h1>Order Details</h1>
            <div class="card">
              <div class="card-body">
      ...
      <div class="col-md-6 offset-md-2 mt-3">
        ...
        <div class=" text-center"> <a href="{{route('invoice',$orderDetails->id)}}" class="btn btn-primary mt-4  ">Print Invoice</a>
        </div>
      </div>
    </div>

    <div class="row">
        <div class="col-6"><h4>Shiping Details</h4>
            <div class="card">
              <div class="card-body">
