                        ...
                        <div class="sidebar__item">
                            ...
                            @csrf
                                <div class="input-group">
                                    <input type="text" class="form-control" min="100"  id="min_amount" placeholder="Min Price">
                                    <span class="input-group-addon">-</span>
                                    <input type="text" class="form-control"  max="500" id="max_amount" placeholder="Max Price">
                        ...
                        <div class="row">
                            <div class="product__discount__slider owl-carousel">
                                @foreach ($products as $product)
                                    <div class="col-lg-4" id="products">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-5">
                                <div class="filter__sort">
                                    <form action="{{ route('short.by') }}" method="GET" id="formname">
                                        <select id="dropdown" name="data" onchange="this.form.submit()">
                                            <option {{ request()->is('products/sort') ? 'selected' : '' }} value="back">
                                                Default</option>
                                            <option
